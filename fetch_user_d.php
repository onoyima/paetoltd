...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT u.firstName, u.lastName, u.email, u.contactNo, u.userImage, p.bankName, p.payers_name, p.uploadDate AS paymentDate, p.room AS roomNumber, p.bed AS bedNumber
