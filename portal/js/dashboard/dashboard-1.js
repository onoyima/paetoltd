...
(function($) {
 ...
 var dlabChartlist = function(){
	...
	var NewCustomers = function(){
		var chartElement = document.querySelector("#NewCustomers");
		...
		var chartBar1 = new ApexCharts(chartElement, options);
		chartBar1.render();
	 
	}
	var NewCustomers1 = function(){
		var chartElement = document.querySelector("#NewCustomers1");
		if (!chartElement) return;
		var options = {
		  series: [
			{
	...
	/* Function ============ */
		return {
			...
			load:function(){
				if (document.querySelector('#NewCustomers')) NewCustomers();
				if (document.querySelector('#NewCustomers1')) NewCustomers1();
				if (document.querySelector('#NewCustomers2')) NewCustomers2();
				if (document.querySelector('#NewCustomers3')) NewCustomers3();
				if (document.querySelector('#activityChart')) activityChart();
				if (document.querySelector('#activityBar1')) activityBar1();
				if (document.querySelector('#pieChart1')) pieChart1();
				if (document.querySelector('span.donut')) donutChart();
