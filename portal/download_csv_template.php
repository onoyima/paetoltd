...
$exampleStudents = [
    ['John Doe', 'VUG/ACC/22/1234', 'ACCOUNTING', '08012345678', '400', '7061234567', $rooms[0] ?? 'ROOM 101', 'A1'],
    ['Jane Smith', 'VUG/LAW/22/5678', 'LAW', '08087654321', '300', '7067654321', $rooms[1] ?? 'ROOM 102', 'B2'],
    ['Bob Wilson', 'VUG/CSC/23/9012', 'COMPUTER SCIENCE', '08011223344', '200', '7061122334', $rooms[2] ?? 'ROOM 103', 'C1'],
    ['Alice Brown', 'VUG/BNS/24/3456', 'NURSING SCIENCE', '08055667788', '100', '7065566778', $rooms[3] ?? 'ROOM 104', 'D2'],
    ['Charlie Davis', 'VUG/MAC/22/7890', 'MASS COMM.', '08099887766', '400', '7069988776', $rooms[4] ?? 'ROOM 105', 'A2'],
];
