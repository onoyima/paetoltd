					...
					<a class="nav-link " href="#;" role="button" data-bs-toggle="dropdown">
						<div class="header-info2 d-flex align-items-center">
							...
							<div class="d-flex align-items-center sidebar-info">
								<div>
									<span class="font-w400 d-block"><?php echo htmlspecialchars(trim(($students_info['firstName'] ?? '') . ' ' . ($students_info['middleName'] ?? '') . ' ' . ($students_info['lastName'] ?? ''))) ?: 'Guest'; ?></span>
										...
										<div class="row ">
											<div class="card">
												<div class="card-body text-center ai-icon  text-primary">
													...
													<a id="dynamic-button" class="btn btn-danger dlabnav-buy" href=" <?php echo htmlspecialchars($button_link); ?>"><?php echo htmlspecialchars($button_text); ?></a>
									...
									<div class="card-body">
											...
											<div class="col-xl-8 col-xxl-7 col-sm-7">
												...
												<div class="ms-4">
													<h3 class="mb-0">
														...
														<?php echo htmlspecialchars($students_info['lastName'] ?? 'Guest'); ?></h3>
													<span class="text-primary d-block mb-xl-3 mb-1"><?php echo htmlspecialchars($students_info['regNo'] ?? 'Guest'); ?>
													</span>
										...
										<div class="row mt-4 align-items-center">
											<div class="col-xl-6 col-sm-6">
												...
												<div>
													<a href="mailto:<?php echo htmlspecialchars($students_info['email'] ?? 'clintonfaze@outlook.com'); ?>" class="icon-btn me-3"> <i class="fas fa-envelope"></i></a>
											...
											<ul class="list-group">
												<?php foreach ($user_payments as $payment) : ?>
													<li class="list-group-item">
														...
														<strong>Bank Name:</strong> <?php echo htmlspecialchars($payment['bankName']); ?><br>
														<strong>Payer's Name:</strong> <?php echo htmlspecialchars($payment['payers_name']); ?><br>
												...
												<?php foreach ($user_payments as $payment) : ?>
													<li class="list-group-item">
														...
														<?php if (!empty($payment['paymentInfo']) && strpos($payment['paymentInfo'], '%PDF-') === 0) : ?>
															...
															<a class="btn btn-primary" href="data:application/pdf;base64,<?php echo base64_encode($payment['paymentInfo']); ?>" download="payment.pdf">Download PDF</a>
														<?php else : ?>

															<img src="data:image/jpeg;base64,<?php echo base64_encode($payment['paymentInfo'] ?? ''); ?>" alt="Payment Image" style="max-width: 100%; height: auto;">
														<?php endif; ?>
													</li>
												<?php endforeach; ?>
											</ul>
